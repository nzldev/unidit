...
describe('Search plugin', function () {
	const search = Unidit.plugins.get('search');
	...
	describe('Disable option', function () {
		it('Should not init plugin', function () {
			...
			expect(editor.container.querySelector('.unidit-search')).is.null;
	...
	describe('CTRL + F', function () {
		it('Should show search form and query field must have focus', function () {
			...
			const search = editor.container.querySelector('.unidit-search');
	...
	describe('CTRL + H', function () {
		it('Should show search and replace form and query field must have focus', function () {
			...
			expect(true).equals(
				search.classList.contains('unidit-search_replace')
			);
	...
	describe('F3 after search', function () {
		it('Should find a next match', function () {
			...
			const search = editor.container.querySelector('.unidit-search');
			expect(search.classList.contains('unidit-search_active')).is.false;
			...
			expect(search.classList.contains('unidit-search_active')).is.true;
			...
			Unidit.modules.Helpers.normalizeNode(editor.editor.firstChild); // because Select module splits text node
	...
	describe('Find by toolbar button event', function () {
			...
			it('Should open search dialog', function () {
				...
				expect(
					editor.container.querySelector(
						'.unidit-search.unidit-search_active'
					)
				).is.not.null;
			});
		});
		...
		describe('Press Replace button', function () {
			it('Should open search dialog', function () {
				...
				expect(
					editor.container.querySelector(
						'.unidit-search.unidit-search_active.unidit-search_replace'
					)
				).is.not.null;
			});
		});
