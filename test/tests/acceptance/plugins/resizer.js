...
describe('Resize plugin', function () {
		...
		describe('In relative object', function () {
			it('should be in front of image', function () {
				...
				div.innerHTML =
					...
					'            <textarea id="text__area0"> <img src="https://nazrul.dev/unidit/build/images/artio.jpg" style="border:1px solid red;width:100px;height:100px;"/></textarea>\n' +
					'        </div>\n' +
					'    </div>';

				document.body.appendChild(div);

				const editor = new Unidit('#text__area0');
				simulateEvent('click', 0, editor.editor.querySelector('img'));

				const resizer = document.querySelector(
					'.unidit-resizer[data-editor_id=text__area0]'
				);
		...
		describe('After resize - popup', function () {
			it('should be hidden and after this should be shown', function () {
				...
				div.innerHTML =
					...
					'        wrong image selection\n' +
					'        <div style="position:relative;text-align: left">\n' +
					'            <textarea id="text__area1"> &lt;img src="https://nazrul.dev/unidit/build/images/artio.jpg" style="border:1px solid red;width:100px;height:100px;"/&gt;</textarea>\n' +
					'        </div>\n' +
					'    </div>';

				document.body.appendChild(div);

				const editor = new Unidit(
				...
				const resizer = editor.ownerDocument.querySelector(
					'.unidit-resizer[data-editor_id=text__area1]'
				);
				expect(resizer).is.not.null;
				//
				const positionResizer = offset(resizer);
		...
		describe('Resize image', function () {
			describe('Size box', function () {
				it('Should show size for image', function (done) {
					...
					const resizer = document.querySelector(
						'.unidit-resizer[data-editor_id=' + editor.id + ']'
					);
					expect(resizer).is.not.null;
				...
				describe('For styled image', () => {
					...
					describe('Disable forImageChangeAttributes', () => {
						it('Should change only styles width and height', done => {
							...
							editor.value =
								'<p><img src="https://nazrul.dev/unidit/build/images/artio.jpg" style="width: 301px;"/></p>';
							...
							onLoadImage(
								...
								() => {
									...
									expect(sortAttributes(editor.value)).eq(
										'<p><img src="https://nazrul.dev/unidit/build/images/artio.jpg" style="height:175px;width:311px"></p>'
									);
									done();
								}
							);
					...
					describe('Enable forImageChangeAttributes', () => {
						describe('Does not has width or height styles', () => {
							it('Should change only attributes width and height', done => {
								...
								editor.value =
									'<p><img src="https://nazrul.dev/unidit/build/images/artio.jpg"/></p>';
								...
								onLoadImage(
									...
									() => {
										...
										expect(sortAttributes(editor.value)).eq(
											'<p><img height="287" src="https://nazrul.dev/unidit/build/images/artio.jpg" width="510"></p>'
										);
										done();
									}
								);
						...
						describe('Has width or height styles', () => {
							describe('Has width style', () => {
								it('Should change attributes width and height and width styles', done => {
									...
									editor.value =
										'<p><img src="https://nazrul.dev/unidit/build/images/artio.jpg" style="width:300px"/></p>';
									...
									onLoadImage(
										...
										() => {
											...
											expect(
												...
												'<p><img height="175" src="https://nazrul.dev/unidit/build/images/artio.jpg" style="width:310px" width="310"></p>'
											);
											done();
										}
									);
							...
							describe('Has height style', () => {
								it('Should change attributes width and height and height styles', done => {
									...
									editor.value =
										'<p><img src="https://nazrul.dev/unidit/build/images/artio.jpg" style="height:300px"/></p>';
									...
									onLoadImage(
										...
										() => {
											...
											expect(
												...
												'<p><img height="306" src="https://nazrul.dev/unidit/build/images/artio.jpg" style="height:306px" width="544"></p>'
											);
											done();
										}
									);
							...
							describe('Has both height and width style', () => {
								it('Should change attributes width and height and width and height styles', done => {
									...
									editor.value =
										'<p><img src="https://nazrul.dev/unidit/build/images/artio.jpg" style="width:300px;height:300px"/></p>';
									...
									onLoadImage(
										...
										() => {
											...
											expect(
												...
												'<p><img height="310" src="https://nazrul.dev/unidit/build/images/artio.jpg" style="height:310px;width:310px" width="310"></p>'
											);
											done();
										}
									);
	...
	describe('For iframes', function () {
		it('should wrap these iframes inside UNIDIT tag', function () {
			const editor = getUnidit();
			editor.value =
			...
			expect(editor.editor.querySelectorAll('unidit').length).equals(2);
			expect(
				editor.editor.querySelector('unidit').firstChild.tagName
			).equals('IFRAME');
		});

		describe('Output HTML', function () {
			it('should not contains UNIDIT tag', function () {
				const editor = getUnidit();
				editor.value =
					'<iframe style="border: 0px currentColor; border-image: none;" src="https://www.google.com/maps/embed" frameborder="0" width="100%" height="500"></iframe>' +
					'<iframe style="border: 0px currentColor; border-image: none;" src="https://www.google.com/maps/embed" frameborder="0" width="100%" height="500"></iframe>';

				expect(editor.editor.querySelectorAll('unidit').length).equals(
					2
				);
