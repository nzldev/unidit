		...
		describe('Click link button', function () {
				...
				describe('Content input was not changed', function () {
					...
					describe('For relative link', function () {
						it('Should work same way', function () {
							...
							expect(editor.value).equals(
								'<p>test <a href="/unidit/docs/">link <strong>strong</strong></a> open</p>'
							);
						});
					});
				});
			...
			describe('Open LINK insert dialog and insert new link', function () {
				it('Should insert new link', function () {
					...
					expect(
						Boolean(url.closest('.unidit-ui-input_has-error_true'))
					).is.true;
					...
					describe('Selected image', function () {
						describe('On open popup', function () {
							it('Should hide text input', function () {
								...
								editor.value =
									'test <img style="width: 100px;height: 100px" src="https://nazrul.dev/unidit/build/images/artio.jpg" alt=""> stop';
						...
						it('Should wrap selected image in link', function () {
							...
							expect(sortAttributes(editor.value)).equals(
								'<p>test <a href="tests/artio.jpg"><img alt="" src="https://nazrul.dev/unidit/build/images/artio.jpg" style="height:100px;width:100px"></a> stop</p>'
							);
			...
			describe('Was selected part of html', function () {
				...
				describe('Was selected image', function () {
						...
						describe('Edit with contect menu', function () {
							it('Should wrap selected image inside the link', function () {
								...
								editor.value =
									...
									'<tbody>' +
									'<tr>' +
									'<td><img src="https://nazrul.dev/unidit/build/images/artio.jpg" alt="test"></td>' +
									'</tr>' +
									'</tbody>' +
									'</table>';
								...
								expect(
									textInput.closest('.unidit-ui-block').style
										.display
								).equals('none');
								...
								expect(sortAttributes(editor.value)).equals(
									'<p>test</p>' +
										...
										'<tbody>' +
										'<tr>' +
										'<td><a href="./shapiro"><img alt="test" src="https://nazrul.dev/unidit/build/images/artio.jpg"></a></td>' +
										'</tr>' +
										'</tbody>' +
										'</table>'
								);
					...
					describe('Image had not anchor parent', function () {
						it('Should show dialog without content input and after submit wrap this image', function () {
							...
							editor.value =
								'<p>one green <img src="https://nazrul.dev/unidit/build/images/artio.jpg" alt="test"> under wall</p>';
							...
							expect(urlInput).is.not.null;
							urlInput.focus();
							urlInput.value = 'https://nazrul.dev';
							urlInput.select();
							...
							expect(sortAttributes(editor.value)).equals(
								'<p>one green <a href="https://nazrul.dev"><img alt="test" src="https://nazrul.dev/unidit/build/images/artio.jpg"></a> under wall</p>'
							);
						});
					});
					...
					describe('Image had anchor parent', function () {
						it('Should show dialog without content input and after submit wrap this image', function () {
							...
							editor.value =
								'<p>one green <a href="https://xdan.ru"><img src="https://nazrul.dev/unidit/build/images/artio.jpg" alt="test"></a> under wall</p>';
				...
				describe('After submit this part', function () {
					it('should be wrapped inside anchor', function () {
						...
						const form = popup.querySelector('.unidit-ui-form');
						expect(form).is.not.null;
						...
						input.value = 'https://nazrul.dev/unidit/';

						simulateEvent('submit', 0, form);

						expect(editor.value).equals(
							'<p>one <a href="https://nazrul.dev/unidit/">green <strong>bottle hanging</strong> under wall</a></p>' +
								'<p><a href="https://nazrul.dev/unidit/">two green <em>bottles hanging</em> under</a> wall</p>'
						);
					});
				});
			});
	...
	describe('Link with class name (modeClassName=input/default)', function () {
		describe('Add class name on link', function () {
			it('Should insert new link with a class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://nazrul.dev/unidit/" class="test">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://nazrul.dev/unidit/" class="test">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
		...
		describe('Modify class name on link', function () {
			it('Should modify link with a new class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://nazrul.dev/unidit/" class="test2">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://nazrul.dev/unidit/" class="test">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
	...
	describe('Link with class name (modeClassName=select)', function () {
		describe('Add class name on link', function () {
			it('Should insert new link with a class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://nazrul.dev/unidit/" class="val1">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://nazrul.dev/unidit/" class="val1">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
		...
		describe('Modify class name on link', function () {
			it('Should modify link with a new class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://nazrul.dev/unidit/" class="val2">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://nazrul.dev/unidit/" class="val1">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
	...
	describe('Link with class name (modeClassName="select", selectMultipleClassName=true)', function () {
		describe('Add class name on link', function () {
			it('Should insert new link with a class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://nazrul.dev/unidit/" class="val1 val3">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://nazrul.dev/unidit/" class="val1 val3">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
		...
		describe('Modify class name on link', function () {
			it('Should modify link with a new class name', function () {
				...
				expect(editor.value).equals(
					'<p>one <a href="https://nazrul.dev/unidit/" class="val1 val2">green <strong>bottle hanging</strong> under wall</a></p>' +
						'<p><a href="https://nazrul.dev/unidit/" class="val1 val3">two green <em>bottles hanging</em> under</a> wall</p>'
				);
			});
		});
