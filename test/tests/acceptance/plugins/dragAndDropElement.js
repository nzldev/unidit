				...
				function () {
					it('Should ' + events[1] + ' dom element', function () {
						...
						editor.value =
							'<p>1111</p>' +
							'<p>2222</p>' +
							'<img style="width: 100px" src="https://nazrul.dev/unidit/build/images/artio.jpg" alt="">' +
							'<p>3333</p>' +
							'<p>4444</p>';
						...
						const box = Unidit.modules.Helpers.position(
						...
						const result =
							'<p>1111</p>' +
							'<p>22<img alt="" src="https://nazrul.dev/unidit/build/images/artio.jpg" style="width:100px">22</p>' +
							'<p>3333</p>' +
							'<p>4444</p>';
			...
			describe(events[1] + ' image inside anchor', function () {
				it('Should ' + events[1] + ' anchor with image', function () {
					...
					editor.value =
						'<p>1111</p>' +
						'<p>2222</p>' +
						'<a href="#test"><img style="width: 100px" src="https://nazrul.dev/unidit/build/images/artio.jpg" alt=""></a>' +
						'<p>3333</p>' +
						'<p>4444</p>';
					...
					expect(editor.value.replace(/2+/g, '2')).equals(
						'<p>1111</p><p>22<a href="#test"><img style="width: 100px" src="https://nazrul.dev/unidit/build/images/artio.jpg" alt=""></a>22</p><p>3333</p><p>4444</p>'.replace(
							/2+/g,
							'2'
						)
					);
			...
			describe('Disable dragging', function () {
				it('Should not move image', function () {
					...
					const defaultValue =
						'<p>1111</p>' +
						'<p>2222</p>' +
						'<p><a href="#test"><img style="width: 100px" src="https://nazrul.dev/unidit/build/images/artio.jpg" alt=""></a></p>' +
						'<p>3333</p>' +
						'<p>4444</p>';
