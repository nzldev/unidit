...
import { FileSelectorWidget, TabsWidget } from 'unidit/modules/widget';
import { Button } from 'unidit/core/ui/button';
import { form, mainTab, positionTab } from './templates/';
import { watch, autobind } from 'unidit/core/decorators';
import { openImageEditor } from 'unidit/modules/image-editor/image-editor';
import { hAlignElement } from 'unidit/plugins/image/helpers';
...
export class imageProperties extends Plugin {
	...
	onChangeSizeIsLocked(): void {
		...
		lockSize.classList.remove('unidit-properties__lock');
		lockSize.classList.remove('unidit-properties__unlock');
	 ...
	 * @example
	 * ```javascript
	 * const editor = Unidit.makeJodit('#editor');
	...
	/** @override */
	protected beforeDestruct(editor: IUnidit): void {
