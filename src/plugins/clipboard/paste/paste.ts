...
import type { InsertMode, PasteEvent } from 'unidit/plugins/clipboard/config';
...
import { Confirm, Dialog } from 'unidit/modules/dialog';
...
export class paste extends Plugin {
	...
	protected beforeDestruct(unidit: IUnidit): void {
		unidit.e.off('paste.paste', this.onPaste);
	}
}
