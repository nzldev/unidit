...
import { attr, isString, keys, safeHTML, trim } from 'unidit/core/helpers';
import { Plugin } from 'unidit/core/plugin';
import { watch, autobind, debounce } from 'unidit/core/decorators';
...
declare module 'unidit/config' {
	interface Config {
		cleanHTML: {
			 ...
			 * <span>mr.</span> <a style="color:red" href="http://nazrul.dev">Freeman</a>';
			 * console.log(editor.value); //Sorry! <a href="http://nazrul.dev">Freeman</a>
			 * ```
			 *
			 * @example
			 * ```javascript
...
export class cleanHtml extends Plugin {
	 ...
	 */
	@debounce<IPlugin<IUnidit>>(ctx => ctx.unidit.o.cleanHTML.timeout)
