...
import { css, dataBind, normalizeColor } from 'unidit/core/helpers/';
import { ColorPickerWidget, TabOption, TabsWidget } from 'unidit/modules/widget';
...
Config.prototype.controls.brush = {
	...
	exec(unidit: IUnidit, current, { button }): void | false {
 ...
 */
export function color(editor: IUnidit): void {
