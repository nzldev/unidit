...
import { debounce, wait, autobind, watch } from 'unidit/core/decorators';
...
export class inlinePopup extends Plugin {
	...
	private popup: IPopup = new Popup(this.unidit, false);
			...
			.on(
				...
				(toolbar: ToolbarCollection): void | Buttons => {
					if (this.toolbar === toolbar) {
						...
						return toArray(unidit.registeredButtons)
							.filter(
								btn =>
