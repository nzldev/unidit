...
import type { IBound, IUnidit, Nullable } from 'unidit/types';
import { Plugin } from 'unidit/core/plugin';
import { Dom, Table } from '../../modules';
import { $$, position } from 'unidit/core/helpers';
import { alignElement } from '../justify/justify';
import { KEY_TAB } from 'unidit/core/constants';
...
export class selectCells extends Plugin {
	...
	protected afterInit(unidit: IUnidit): void {
		if (!unidit.o.table.allowCellSelection) {
			return;
		}
