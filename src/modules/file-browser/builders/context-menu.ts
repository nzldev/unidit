...
import { attr, error } from 'unidit/core/helpers';
import { makeContextMenu } from 'unidit/modules/file-browser/factories';
...
const CLASS_PREVIEW = 'unidit-filebrowser-preview',
							...
							exec: () => {
								const preview = new Dialog({
									...
									temp_content = self.c.div(
										CLASS_PREVIEW,
										'<div class="unidit-icon_loader"></div>'
									),
