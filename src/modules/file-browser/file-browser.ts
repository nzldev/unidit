...
import { Storage } from 'unidit/core/storage';
import {
	error,
	isFunction,
	isString,
...
import { observable } from 'unidit/core/event-emitter';
...
export class FileBrowser extends ViewWithToolbar implements IFileBrowser {
	 ...
	 * @example
	 * ```javascript
	 * var fb = new Unidit.modules.FileBrowser(parent);
	...
	private initUploader(editor?: IFileBrowser | IUnidit) {
		const self = this,
