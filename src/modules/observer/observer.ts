...
import type { IUnidit, SnapshotType, IObserver } from 'unidit/types';
 ...
 */
export class Observer extends ViewComponent<IUnidit> implements IObserver {
	/** @override */
	className(): string {
		return 'Observer';
	}
