...
import { UIButton, UIButtonState } from 'unidit/core/ui/button';
...
import { ToolbarCollection } from 'unidit/modules/toolbar/collection/collection';
import { STATUSES } from 'unidit/core/component';
import { findControlType } from 'unidit/core/ui/helpers/get-control-type';
	...
	implements IToolbarButton
{
	...
	constructor(
		...
		// Prevent lost focus
		unidit.e.on([this.button, this.trigger], 'mousedown', (e: MouseEvent) =>
			e.preventDefault()
		);
	...
	private openControlList(control: IControlTypeStrongList): void {
		const controls: Controls = this.unidit.options.controls ?? {},
