...
import { getStrongControlTypes } from 'unidit/core/ui/helpers/get-strong-control-types';
import { component, watch } from 'unidit/core/decorators';
import { UIGroup } from 'unidit/core/ui/group/group';
import { UISeparator } from 'unidit/core/ui/group/separator';
import { UISpacer } from 'unidit/core/ui/group/spacer';
import { UIButton } from 'unidit/core/ui/button/button/button';
import { isButtonGroup } from 'unidit/core/ui/helpers/buttons';
import { getControlType } from 'unidit/core/ui/helpers/get-control-type';
import { splitArray } from 'unidit/core/helpers/array';
	...
	implements IUIList
{
	...
	private makeGroup(): IUIGroup {
		return new UIGroup(this.unidit);
	}
