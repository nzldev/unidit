...
import { attr, toArray } from 'unidit/core/helpers';
import { Dom } from 'unidit/core/dom';
import { autobind, component, debounce, watch } from 'unidit/core/decorators';
import { Icon } from 'unidit/core/ui/icon';
import { inputValidators } from 'unidit/core/ui/form/validators';
...
export class UIInput extends UIElement implements IUIInput {
	...
	/** @override **/
	constructor(unidit: IViewBased, options?: Partial<IUIInput['state']>) {
		super(unidit, options);
