...
import { attr, error } from 'unidit/core/helpers/utils';
import { Dom } from 'unidit/core/dom';
import { camelCase } from 'unidit/core/helpers/string';
import { toArray } from 'unidit/core/helpers/array';
 ...
 * @example
 * ```javascript
 * Unidit.modules.Helpers.$$('.someselector').forEach(function (elm) {
