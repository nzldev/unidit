...
export const IS_BLOCK =
	/^(ARTICLE|SCRIPT|STYLE|OBJECT|FOOTER|HEADER|NAV|SECTION|IFRAME|UNIDIT|UNIDIT-MEDIA|PRE|DIV|P|LI|UL|OL|H[1-6]|BLOCKQUOTE|TR|TD|TH|TBODY|THEAD|TABLE|BODY|HTML|FIGCAPTION|FIGURE|DT|DD|DL|DFN)$/i;
...
export const MARKER_CLASS = 'unidit-selection_marker';
...
export const TEMP_ATTR = 'data-unidit-temp';
