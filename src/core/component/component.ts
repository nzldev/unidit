...
import { uniqueUid } from 'unidit/core/global';
import { STATUSES } from 'unidit/core/component/statuses';
...
/**
 * The base class of all Unidit UI components. Provides work with a life cycle.
 */
export abstract class Component implements IComponent {
	...
	/**
	 * The document in which unidit was created
	 */
	...
	/**
	 * The window in which unidit was created
	 */
