...
import { isArray, isFastEqual, isPlainObject } from 'unidit/core/helpers';
import { getPropertyDescriptor } from 'unidit/core/decorators';
 ...
 * }
 *
 * const obsObj = Unidit.modules.observable(obj);
