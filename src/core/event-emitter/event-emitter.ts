...
import { isFunction } from 'unidit/core/helpers/checker/is-function';
import { isArray } from 'unidit/core/helpers/checker/is-array';
...
export class EventEmitter implements IEventEmitter {
	 ...
	 * ```javascript
	 *  var events = new Unidit.modules.EventEmitter();
